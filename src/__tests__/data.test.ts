...
// Feature: packmate-skeleton-ui, Property 7: App Data Completeness
// **Validates: Requirements 8.2, 8.3**

describe('App Data Completeness', () => {
    ...
    fc.assert(
      fc.property(
        ...
        (index) => {
          ...
          // availability: object with macos, linux, windows boolean flags
          expect(typeof app.availability).toBe('object');
          expect(typeof app.availability.macos).toBe('boolean');
          expect(typeof app.availability.linux).toBe('boolean');
          expect(typeof app.availability.windows).toBe('boolean');
